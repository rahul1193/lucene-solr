...
public class ReaderCloneFactory {
     ...
     * @param <T> The base class handled.
     */
    public interface ReaderCloner<T extends Reader> {
         ...
         * @see #giveAClone()
         */
        void init(T originalReader, String expectedPrefix) throws IOException;
    ...
    static {
        ...
        bindCloner(StringReader.class, StringReaderCloner.class);
    }
            ...
            if (forReader != null) {
                ...
                if (unwrapper != null) {
                    try {
                        ...
                        if (unwrapped != null) {
                            return (ReaderCloner<T>) ReaderCloneFactory
                                    .getCloner(Reader.class, (Class<Reader>) unwrapped.getClass(), unwrapped, expectedPrefix);
                        }
    ...
    public static <T extends Reader, S extends T> ReaderCloner<T> getCloner(Class<T> baseClass, Class<S> forClass) {
        return ReaderCloneFactory.<T, S>getCloner(baseClass, forClass, null, null);
    }
    ...
    public static <S extends Reader> ReaderCloner<Reader> getCloner(Class<S> forClass) {
        return ReaderCloneFactory.<Reader, S>getCloner(Reader.class, forClass, null, null);
    }
    ...
    public static <S extends Reader> ReaderCloner<Reader> getCloner(S forReader) {
        return getCloner(forReader, null);
    }

    public static <S extends Reader> ReaderCloner<Reader> getCloner(S forReader, String expectedPrefix) {
        if (forReader != null) {
            return ReaderCloneFactory.<Reader, S>getCloner(Reader.class, (Class<S>) forReader.getClass(), forReader, expectedPrefix);
        } else {
    ...
    public static ReaderCloner<Reader> getGenericCloner() {
        return ReaderCloneFactory.getCloner(Reader.class, Reader.class, null, null);
    }
